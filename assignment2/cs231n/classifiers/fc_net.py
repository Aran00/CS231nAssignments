...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    scores, affine2_cache = affine_forward(layer1_out, W2, b2)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    dlayer1_out, dW2, db2 = affine_backward(dscores, affine2_cache)
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    scores, affine_cache = affine_forward(former_output, W_last, b_last)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
